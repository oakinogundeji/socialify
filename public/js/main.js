...
module.exports = '<section id="app-chat" class="col-xs-12 col-md-5">\n  <div id="chat-address-bar" class="row">\n    <h3 class="text-center">{{userProfileInfo.fname}} {{userProfileInfo.lname}}:\n      {{userProfileInfo.email}} / {{chatTarget}}</h3>\n  </div>\n  <div id="chat-box" class="col-xs-8">\n    <div id="chat-box-display">\n      <div v-for="item in chatMsgs">\n        <p>{{item.from}}: {{item.msg}}</p>\n      </div>\n    </div>\n    <form id="chat-box-input" class="form-group"\n    @submit.stop.prevent="sendChatMsg">\n      <div class="form-group">\n        <input type="text" v-model="newMsg" class="form-control">\n      </div>\n      <div class="form-group">\n        <input class="btn btn-success btn-default" value="Send" type="button"\n        @click.stop.prevent="sendChatMsg">\n        <input class="btn btn-danger btn-default" value="Cancel" type="button"\n        @click.stop.prevent="discardChatMsg">\n      </div>\n    </form>\n    <span v-show="showWarnMsg" class="errMsg">Please choose a recipient or discard the message!</span>\n  </div>\n  <div id="chat-status-box" class="col-xs-4">\n    <div class="row">\n      <h3 class="text-info text-center">Online friends</h3>\n    </div>\n    <div id="chat-online-friends" class="row">\n      <div v-for="item in onlineFriends">\n        <a href="" @click.stop.prevent="setChatTarget(item)"><p>{{item.firstName}} {{item.lastName}}: {{item.email}}</p></a>\n      </div>\n    </div>\n  </div>\n  <!--<pre>{{$data | json}}</pre>-->\n</section>\n';
...
},{"./template.html":43}],43:[function(require,module,exports){
module.exports = '<nav id="app-nav" class="navbar navbar-default col-xs-8">\n  <ul class="nav nav-tab">\n    <li v-show="showHub"><a v-link="{ name: \'hub\' }">Hub</a></li>\n    <li><a v-link="{ name: \'profile\' }">Profile</a></li>\n  </ul>\n</nav>\n';
...
},{"./template.html":45}],45:[function(require,module,exports){
module.exports = '<section>\n  <template v-if="showForm">\n    <h1>Create your Hub</h1>\n    <div>\n      <form>\n        <div class="form-group">\n          <label for="hubTile">Title</label>\n          <input type="text" class="form-control" id="hubMetaData"\n          placeholder="Title e.g. My awesome page" v-model="hubTitle" lazy>\n        </div>\n        <div class="form-group">\n          <label for="hubDescription">Description</label>\n          <textarea class="form-control" rows="5" id="hubDescription" v-model="hubDescription" lazy\n          placeholder="Briefly describe your new hub e.g. this is my portal to the world!!!"></textarea>\n        </div>\n        <div class="form-group">\n          <label for="userStatus">Status</label>\n          <input type="text" class="form-control" id="userStatus" v-model="userStatus" lazy\n          placeholder="e.g. Socialify rockzxxx!!">\n        </div>\n        <div class="form-group">\n          <label for="hubPwdRecovery">Password recovery email account</label>\n          <input type="email" class="form-control" id="hubPwdRecovery"\n          placeholder="another@email.com" v-model="pwdRecoveryEmail" lazy>\n        </div>\n        <button type="submit" class="btn btn-success btn-default"\n        @click.stop.prevent="submitData">Submit</button>\n      </form>\n    </div>\n    <span v-show="showErrMsg">Please provide valid data for all form fields</span>\n  </template>\n</section>\n';
...
},{"./template.html":49}],49:[function(require,module,exports){
module.exports = '<section>\n    <template v-if="showInput">\n      <h1>Upload your profile photo</h1>\n      <div class="form-group">\n        <label for="profile-photo">Profile Photo</label>\n        <!--NB \'user-pix\' is in kebab-case here but is used in camelCase on the\n      component!-->\n        <input type="file" id="profile-photo" v-el:user-pix>\n        <div v-show="showUpload" class="file-upload-progress"></div>\n        <button type="submit" class="btn btn-success btn-default"\n        @click.stop.prevent="uploadPix">Upload</button>\n      </div>\n      <span v-show="showErrMsg">Please select a profile photo</span>\n      <!--<pre>{{$data | json}}</pre>-->\n    </template>\n</section>\n';
...
},{"./baseAppTemplate.html":33,"./components/app_chat":34,"./components/app_contact_list":36,"./components/app_feeds":38,"./components/app_hub":40,"./components/app_nav":42,"./components/app_newhub":44,"./components/app_profile":46,"./components/app_profilepix":48,"./components/friend_hub":50,"barn":1,"jquery":6,"vue":32,"vue-resource":20,"vue-router":31}]},{},[52]);
